...
export default function signup() {
  ...
  const callSubmit = (e) => {
    ...
    axios.post("https://ecommerce-sagartmg2.vercel.app/api/users/signup", {
      ...
      .then((res) => {
        toast.success("loggned succesfull")
        // console.log("loggned sucessful")
        navigate("/")
      })
      .catch((err) => {
        // console.log(err);
  ...
  return <>
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" onSubmit={callSubmit}>
        <div>
          ...
          <div>
            ...
            <div class="mt-2">
              <input id="role" name="role" type="text" autocomplete="role" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
